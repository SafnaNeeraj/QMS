...
// import copyQuoteLineItem from '@salesforce/apex/addProduct.copyQuoteLineItem';
...
// copyQuoteLineItem({qliId: this.quoteLineId})
// .then(res=>{
//      this.result = res;
//      this.error = undefined;
...
//      }
//      if(res[0].Annual_Usage__c != null){
//         this.Annual_Usage__c = res[0].Annual_Usage__c;
//      }
...
//      }
//      if(res[0].No_of_Parts_Vehicle__c != null){
//         this.partsValue = res[0].No_of_Parts_Vehicle__c;
//      }
//      if(res[0].Est_Annual_Usage__c != null){
//         this.annualValue = res[0].Est_Annual_Usage__c;
//      }
// })
// .catch(err=>{
...
handleNotFeasibleChange(event){
  this.handleNotFeasibleChange  = event.target.value;
}
...
handleFeasibleCustomerChange(event){
    ...
    console.log('change feasible '+this.Feasible_Customer__c)
}
