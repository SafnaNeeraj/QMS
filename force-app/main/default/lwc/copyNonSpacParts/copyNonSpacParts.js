...
import copyNonSpac from '@salesforce/apex/addProduct.copyNonSpac'
export default class CopyNonSpacParts extends LightningElement {
   @api recordId;
   @track data;
   result;
   @track error;
   ...
   connectedCallback() {
      if (this.recordId) {
         ...
         copyNonSpac({ qliId: this.quoteLineId })
            .then(res => {
               this.result = res;
               this.error = undefined;
